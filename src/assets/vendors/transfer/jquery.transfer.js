...
(function ($) {
  ...
  Transfer.prototype.generate_transfer = function () {
    var template =
      parseHTMLTemplate(`<div class="transfer-double" id="transfer_double_{{= self.id }}">
                <div class="transfer-double-header"></div>
                <div class="transfer-double-content d-flex">
  
                    {{ // left part start }}
  
                    <div class="transfer-double-content-left p-2">
                        <div class="transfer-double-content-param mb-2">
                    ...
                    <div class="transfer-double-content-middle">
                        <div class="btn-select-arrow" id="add_selected_{{= self.id }}"><i class="fas fa-arrow-alt-circle-right"></i></div>
                        <div class="btn-select-arrow" id="delete_selected_{{= self.id }}"><i class="fas fa-arrow-alt-circle-left"></i></div>
                    </div>
  
                    {{ // right part start }}
  
                    <div class="transfer-double-content-right p-2">
                        <div class="transfer-double-content-param mb-2">
                        ...
                        <div class="transfer-double-selected-list">
                            <div class="transfer-double-selected-list-header">
                                <div class="transfer-double-selected-list-search mb-2">
                                    <input class="transfer-double-selected-list-search-input form-control form-control-sm" type="text" id="selectedListSearch_{{= self.id }}" placeholder="{{= self.searchPlaceholderText }}" value="" />
                                </div>
                            </div>
                            <div class="transfer-double-selected-list-content">
                                <div class="transfer-double-selected-list-main mb-2">
                                    <ul class="transfer-double-selected-list-ul perfect-scroll-delay list-unstyled transfer-double-selected-list-ul-{{= self.id }}"></ul>
                                </div>
                            </div>
                            <div class="transfer-double-list-footer">
                                <div class="checkbox-group form-check">
                                    <input type="checkbox" class="checkbox-normal form-check-input" id="rightItemSelectAll_{{= self.id }}">
                                    <label for="rightItemSelectAll_{{= self.id }}" class="form-check-label selected_total_num_{{= self.id }}"></label>
                                </div>
                            </div>
                        </div>
                    </div>
  ...
  Transfer.prototype.generate_group_items_container = function () {
    var template =
      parseHTMLTemplate(`<div class="transfer-double-list transfer-double-list-{{= self.id }}">
                <div class="transfer-double-list-header">
                    <div class="transfer-double-list-search mb-2">
                        <input class="transfer-double-list-search-input form-control form-control-sm" type="text" id="groupListSearch_{{= self.id }}" placeholder="{{= self.searchPlaceholderText }}" value="" />
                    </div>
                </div>
                <div class="transfer-double-list-content">
                    <div class="transfer-double-list-main mb-2">
                        <ul class="transfer-double-group-list-ul perfect-scroll-delay list-unstyled transfer-double-group-list-ul-{{= self.id }}"></ul>
                    </div>
                </div>
                <div class="transfer-double-list-footer">
                    <div class="checkbox-group form-check">
                        <input type="checkbox" class="form-check-label checkbox-normal form-check-input" id="groupItemSelectAll_{{= self.id }}"><label for="groupItemSelectAll_{{= self.id }}" class="group_total_num_{{= self.id }}"></label>
                    </div>
                </div>
            </div>`);
  ...
  Transfer.prototype.generate_items_container = function () {
    var template =
      parseHTMLTemplate(`<div class="transfer-double-list transfer-double-list-{{= self.id }}">
                <div class="transfer-double-list-header">
                    <div class="transfer-double-list-search mb-2">
                        <input class="transfer-double-list-search-input form-control form-control-sm" type="text" id="listSearch_{{= self.id }}" placeholder="{{= self.searchPlaceholderText }}" value="" />
                    </div>
                </div>
                <div class="transfer-double-list-content">
                    <div class="transfer-double-list-main mb-2">
                        <ul class="transfer-double-list-ul perfect-scroll-delay list-unstyled transfer-double-list-ul-{{= self.id }}"></ul>
                    </div>
                </div>
                <div class="transfer-double-list-footer">
                    <div class="checkbox-group form-check">
                        <input type="checkbox" class="form-check-label checkbox-normal form-check-input" id="leftItemSelectAll_{{= self.id }}"><label for="leftItemSelectAll_{{= self.id }}" class="total_num_{{= self.id }}"></label>
                    </div>
                </div>
            </div>`);
  ...
  Transfer.prototype.generate_left_items = function () {
    ...
    var template =
      parseHTMLTemplate(`<li class="transfer-double-list-li transfer-double-list-li-{{= self.id }} {{= selected ? 'selected-hidden' : ' ' }}">
                <div class="checkbox-group form-check">
                    <input {{= disabled ? disabled="disabled" : "" }} type="checkbox" value="{{= dataArray[i][valueName] }}" class="checkbox-normal form-check-input checkbox-item-{{= self.id }}" id="itemCheckbox_{{= i }}_{{= self.id }}">
                    <label class="form-check-label checkbox-name-{{= self.id }}" for="itemCheckbox_{{= i }}_{{= self.id }}">{{= dataArray[i][itemName] }}</label>
                </div>
            </li>`);
  ...
  Transfer.prototype.generate_left_group_items = function () {
    ...
    var groupItemTemplate =
      parseHTMLTemplate(`<li class="transfer-double-group-list-li-ul-li transfer-double-group-list-li-ul-li-{{= self.id }} {{= selected ? 'selected-hidden' : '' }}">
                <div class="checkbox-group form-check">
                    <input type="checkbox" value="{{= groupDataArray[i][groupArrayName][j][valueName] }}" class="checkbox-normal form-check-input group-checkbox-item-{{= self.id }} belongs-group-{{= i }}-{{= self.id }}" id="group_{{= i }}_checkbox_{{= j }}_{{= self.id }}">
                    <label for="group_{{= i }}_checkbox_{{= j }}_{{= self.id }}" class="form-check-label group-checkbox-name-{{= self.id }}">{{= groupDataArray[i][groupArrayName][j][itemName] }}</label>
                </div>
            </li>`);

    var groupTemplate =
      parseHTMLTemplate(`<li class="transfer-double-group-list-li transfer-double-group-list-li-{{= self.id }}">
                <div class="checkbox-group form-check">
                    <input type="checkbox" class="checkbox-normal form-check-input group-select-all-{{= self.id }}" id="group_{{= i }}_{{= self.id }}">
                    <label for="group_{{= i }}_{{= self.id }}" class="form-check-label group-name-{{= self.id }}">{{= groupDataArray[i][groupItemName] }}</label>
                </div>
                <ul class="transfer-double-group-list-li-ul ms-3 list-unstyled transfer-double-group-list-li-ul-{{= self.id }}">`);
      ...
      for (var j = 0; j < transferDoubleGroupListLiUlLis.length; j++) {
        if (
          ...
          transferDoubleGroupListLiUlLis
            ...
            .toLowerCase() == $(self.groupItemSearcherId).val().toLowerCase()
        ) {
          transferDoubleGroupListLiUlLis
            .eq(j)
            .parent("ul")
  ...
  Transfer.prototype.generate_item = function (
    ...
    var template =
      parseHTMLTemplate(`<li class="transfer-double-selected-list-li  transfer-double-selected-list-li-{{= id }} .clearfix">
                <div class="checkbox-group form-check">
                    <input {{= disabled ? disabled="disabled" : " " }} type="checkbox" value="{{= value }}" class="checkbox-normal form-check-input checkbox-selected-item-{{= id }}" id="selectedCheckbox_{{= index }}_{{= id }}">
                    <label class="form-check-label checkbox-selected-name-{{= id }}" for="selectedCheckbox_{{= index }}_{{= id }}">{{= labelText }}</label>
                </div>
            </li>`);
  ...
  Transfer.prototype.generate_group_item = function (
    ...
    var template =
      parseHTMLTemplate(`<li class="transfer-double-selected-list-li transfer-double-selected-list-li-{{= id }} .clearfix">
                <div class="checkbox-group form-check">
                    <input type="checkbox" value="{{= value }}" class="checkbox-normal form-check-input checkbox-selected-item-{{= id }}" id="group_{{= groupIndex }}_selectedCheckbox_{{= itemIndex }}_{{= id }}">
                    <label class="form-check-label checkbox-selected-name-{{= id }}" for="group_{{= groupIndex }}_selectedCheckbox_{{= itemIndex }}_{{= id }}">{{= labelText }}</label>
                </div>
            </li>`);
